...
describe('endpoint', function () {
    ...
    it('should be instantiable', function () {
        var path = '/api/socket';
        var socketServer = {};
        expect(new endpoint_1.Endpoint(path, socketServer, function () {
        })).toBeInstanceOf(endpoint_1.Endpoint);
    });
    it('should have a createChannel method', function () {
        var path = '/api/socket';
        var socketServer = {};
        var endpoint = new endpoint_1.Endpoint(path, socketServer, function () {
        });
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, superwstest_1.default)(server)
                            ...
                            .sendJson(message)
                            .expectJson({
                            action: "PRESENCE", event: "ADD_TO_POND", channelName: "/test/socket", payload: {
                                presence: [],
                                change: {
                                    status: "online",
                                }
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, superwstest_1.default)(server)
                            ...
                            .expectJson({
                            action: "PRESENCE", event: "ADD_TO_POND", channelName: "/socket/socket", payload: {
                                presence: [], change: {
                                    status: "online socket",
                                }
                            }
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, superwstest_1.default)(server)
                            ...
                            .expectJson({
                            action: "ERROR", event: "JOIN_CHANNEL", channelName: "/socket/socket", payload: {
                                message: "The channel was not found", code: 4004
                            }
                        })];
                case 2:
                    _a.sent();
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, superwstest_1.default)(server)
                            ...
                            .expectJson({
                            action: "PRESENCE", event: "UPDATE_IN_POND", channelName: "/test/socket", payload: {
                                presence: [{}], change: {
                                    status: 'online'
                                }
                            }
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, superwstest_1.default)(server)
                            ...
                            .expectJson({
                            action: "PRESENCE", event: "ADD_TO_POND", channelName: "/test/socket2", payload: {
                                presence: [], change: {}
                            }
                        })
                            .sendJson(__assign(__assign({}, message), { action: enums_1.ClientActions.LEAVE_CHANNEL, channelName: '/test/socket2' }))
                            .expectJson({
                            action: "PRESENCE", payload: {
                                presence: [{}],
                                change: null
                            }, event: "REMOVE_FROM_POND", channelName: "/test/socket2"
                        })];
                case 2:
                    _a.sent();
