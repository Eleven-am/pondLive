...
var Endpoint = /** @class */ (function (_super) {
    ...
    function Endpoint(path, server, handler) {
    ...
    Endpoint.prototype.authoriseConnection = function (request, socket, head, data) {
        var _this = this;
        return (0, basePromise_1.BasePromise)(socket, function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 7:
                        ...
                        else if (e_3 instanceof basePromise_1.PondError) {
                            message_2 = {
                                action: enums_1.ServerActions.ERROR,
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 4];
                    case 3: throw new basePromise_1.PondError('The channel was not found', 4004, {
    ...
    Endpoint.prototype._channelAction = function (channelName, event, action) {
        ...
        if (!channel)
            throw new basePromise_1.PondError('Channel not found', 404, { channelName: channelName, event: event });
