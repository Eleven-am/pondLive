...
var PondChannel = /** @class */ (function (_super) {
    ...
    PondChannel.prototype.on = function (event, callback) {
        ...
        var resolver = function (data) {
            ...
            if (info) {
                ...
                var resolver_1 = function (innerData) {
                ...
                var response = new pondResponse_1.PondResponse(data.clientId, assigns, resolver_1);
    ...
    PondChannel.prototype.addUser = function (user, channelName, joinParams) {
        var _this = this;
        return (0, basePromise_1.BasePromise)({ channelName: channelName }, function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
