...
describe('PondBase', () => {
    ...
    it('should set and get a value', () => {
        const pond = new pondBase_1.PondBase();
    ...
    it('should update a document in the pond', () => {
        ...
        expect(() => pond.update('not-a-real-id', 'temp2')).toThrowError(basePromise_1.PondError);
    });
    it('should be capable of merging one pond base into another', () => {
        const pond1 = new pondBase_1.PondBase();
        pond1.set('bar');
        pond1.set('chips');
        pond1.set('dog');
        const pond2 = new pondBase_1.PondBase();
        pond2.set('bar');
        pond2.set('chips');
        pond2.set('dog');
        pond1.merge(pond2);
