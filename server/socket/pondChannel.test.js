        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    doc.removeDoc();
                    expect(function () { return pondChannel.getChannelInfo('/test'); }).toThrowError(utils_1.PondError); // channel is removed from the pond channel and can not be found
                ...
                case 4:
                    error_1 = _a.sent();
                    expect(error_1).toBeInstanceOf(utils_1.PondError); // this is because, the pondChannel handler doesn't act on the response
                    expect(error_1).toEqual(new utils_1.PondError('Function did not resolve a Promise', 500, {
                        channelName: '/test',
                    }));
                    return [3 /*break*/, 5];
                case 5:
                ...
                case 9:
                    error_2 = _a.sent();
                    expect(error_2).toBeInstanceOf(utils_1.PondError); // this is because we reject the connection
                    expect(error_2).toEqual(new utils_1.PondError('test', 69420, {
                ...
                case 12:
                    error_3 = _a.sent();
                    expect(error_3).toBeInstanceOf(utils_1.PondError); // this is because we reject the connection
                    expect(error_3).toEqual(new utils_1.PondError('Message rejected', 403, {
                        channelName: '/balls',
                    }));
                    return [3 /*break*/, 13];
                case 13:
