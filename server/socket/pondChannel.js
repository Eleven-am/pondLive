...
var PondChannel = /** @class */ (function (_super) {
    ...
    PondChannel.prototype.addUser = function (user, channelName, joinParams) {
        var _this = this;
        return (0, utils_1.BasePromise)({ channelName: channelName }, function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        response = new utils_1.PondResponse({ channelName: channelName }, assigns, resolver);
    ...
    PondChannel.prototype._buildHandler = function (event, callback) {
        ...
        return function (data) {
            ...
            if (info) {
                ...
                var response = new utils_1.PondResponse(data.clientId, assigns, resolver);
