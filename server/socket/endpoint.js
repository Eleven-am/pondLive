...
var Endpoint = /** @class */ (function (_super) {
    ...
    function Endpoint(server, handler) {
        ...
        _this._channels = new utils_1.PondBase();
        _this._sockets = new utils_1.PondBase();
    ...
    Endpoint.prototype.authoriseConnection = function (request, socket, head, data) {
        var _this = this;
        return (0, utils_1.BasePromise)(socket, function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        res = new utils_1.PondResponse(socket, assign, resolver, false);
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 7:
                        ...
                        else if (e_3 instanceof utils_1.PondError) {
                            message_2 = {
                                action: enums_1.ServerActions.ERROR,
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 4];
                    case 3: throw new utils_1.PondError('The channel was not found', 4004, {
    ...
    Endpoint.prototype._channelAction = function (channelName, event, action) {
        ...
        if (!channel)
            throw new utils_1.PondError('Channel not found', 404, { channelName: channelName, event: event });
