...
export class ContextManager<ContextType extends Object> {
...
export function createContext<ContextType extends Object>(contextId: string): ContextFactoryType<ContextType> {
