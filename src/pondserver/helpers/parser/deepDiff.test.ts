...
describe('DeepDiffMapper', () => {
    it('should return unchanged if both objects are the same', () => {
        ...
        const result = DeepDiffMapper(obj1, obj2);
    ...
    it('should return deleted if the second object is undefined', () => {
        ...
        const result = DeepDiffMapper(obj1, {});
        expect(result).toEqual({
            a: {
                type: 'deleted',
                data: 1,
    ...
    it('should throw an error if 2 functions are passed', () => {
        ...
        expect(() => DeepDiffMapper(obj1, obj2)).toThrow('Invalid argument. Function given, object expected.');
    });
    ...
    it('should ignore a nested function', () => {
        const obj1 = {
            ...
            b: {
                c: 2,
                d: () => { // since it ignores functions, this would be treated as undefined
                },
            },
        };
        const obj2 = {
    ...
    it('should compare dates', () => {
        ...
        const result2 = DeepDiffMapper(obj1, obj3);
